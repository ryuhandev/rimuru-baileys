...
exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestryuhanVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
...
const ryuhan_version_json_1 = require("../Defaults/ryuhan-version.json");
...
const fetchLatestryuhanVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/ryuhan', {
            ...options,
            responseType: 'json'
        });
        ...
        return {
            version: ryuhan_version_json_1.version,  
            isLatest: false,
            error
        };
    }
};
exports.fetchLatestryuhanVersion = fetchLatestryuhanVersion;

const fetchLatestBaileysVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/@ryuhan/baileys', {
            ...options,
            responseType: 'json'
        });
        const versionStr = data.version; 
