...
const cleanMessage = (message, meId, meLid) => {
    ...
    if ((0, WABinary_1.isHostedLidUser)(message.key.remoteJid) || (0, WABinary_1.isHostedPnUser)(message.key.remoteJid)) {
        message.key.remoteJid = (0, WABinary_1.jidEncode)((0, WABinary_1.jidDecode)(message.key === null || message.key === void 0 ? void 0 : message.key.remoteJid) === null || (0, WABinary_1.jidDecode)(message.key === null || message.key === void 0 ? void 0 : message.key.remoteJid) === void 0 ? void 0 : (0, WABinary_1.jidDecode)(message.key === null || message.key === void 0 ? void 0 : message.key.remoteJid).user, (0, WABinary_1.isHostedPnUser)(message.key.remoteJid) ? 's.whatsapp.net' : 'lid');
    }
    else {
        try {
    ...
    if ((0, WABinary_1.isHostedLidUser)(message.key.participant) || (0, WABinary_1.isHostedPnUser)(message.key.participant)) {
        message.key.participant = (0, WABinary_1.jidEncode)((0, WABinary_1.jidDecode)(message.key.participant) === null || (0, WABinary_1.jidDecode)(message.key.participant) === void 0 ? void 0 : (0, WABinary_1.jidDecode)(message.key.participant).user, (0, WABinary_1.isHostedPnUser)(message.key.participant) ? 's.whatsapp.net' : 'lid');
    }
