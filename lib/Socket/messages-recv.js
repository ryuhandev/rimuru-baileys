...
const makeMessagesRecvSocket = (config) => {
    ...
    const { ev, authState, ws, processingMutex, messageMutex, notificationMutex, receiptMutex, signalRepository, query, upsertMessage, resyncAppState, groupMetadata, onUnexpectedError, assertSessions, sendNode, relayMessage, sendReceipt, uploadPreKeys, createParticipantNodes, getUSyncDevices, sendPeerDataOperationMessage, messageRetryManager } = sock;
    ...
    const identityAssertDebounce = config.identityAssertDebounceCache || new node_cache_1.default({ stdTTL: 5, useClones: false });
    ...
    const sendRetryRequest = async (node, forceIncludeKeys = false) => {
        ...
        // Use new message retry manager if available
        ...
        // Check if we should recreate session
        ...
        // Request phone resend on first retry
        if (retryCount <= 2) {
            if (messageRetryManager) {
                ...
                content: [
                    {
                        ...
                        attrs: {
                            ...
                            t: node.attrs.t,
                            v: '1',
                            error: '0' // Add error field like blckrose
                        }
                    },
                    {
                        tag: 'registration',
    ...
    const handleEncryptNotification = async (node) => {
        ...
        if (from === WABinary_1.S_WHATSAPP_NET) {
            ...
            // Use improved identity change handler with debouncing
            const result = await (0, Utils_1.handleIdentityChange)(node, {
                meId: authState.creds.me === null || authState.creds.me === void 0 ? void 0 : authState.creds.me.id,
                meLid: authState.creds.me === null || authState.creds.me === void 0 ? void 0 : authState.creds.me.lid,
    ...
    const handleGroupNotification = (fullNode, child, msg) => {
        ...
        const affectedParticipantLid = (0, WABinary_1.getBinaryNodeChild)(child, 'participant') === null || (0, WABinary_1.getBinaryNodeChild)(child, 'participant') === void 0 ? void 0 : (0, WABinary_1.getBinaryNodeChild)(child, 'participant').attrs.jid || actingParticipantLid;
        const affectedParticipantPn = (0, WABinary_1.getBinaryNodeChild)(child, 'participant') === null || (0, WABinary_1.getBinaryNodeChild)(child, 'participant') === void 0 ? void 0 : (0, WABinary_1.getBinaryNodeChild)(child, 'participant').attrs.phone_number || actingParticipantPn;
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            ...
            case 'subject':
                ...
                break;
            case 'description':
                const description = (0, WABinary_1.getBinaryNodeChild)(child, 'body') === null || (0, WABinary_1.getBinaryNodeChild)(child, 'body') === void 0 ? void 0 : (0, WABinary_1.getBinaryNodeChild)(child, 'body').content.toString();
            ...
            case 'created_membership_requests':
                ...
                msg.messageStubParameters = [affectedParticipantLid, 'created', child.attrs.request_method];
                break;
            case 'revoked_membership_requests':
                const isDenied = (0, WABinary_1.areJidsSameUser)(affectedParticipantLid, actingParticipantLid);
                msg.messageStubType = Types_1.WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD;
                msg.messageStubParameters = [affectedParticipantLid, isDenied ? 'revoked' : 'rejected'];
                break;
            default:
