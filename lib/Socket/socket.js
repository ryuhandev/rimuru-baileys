...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey = "MURUSAMA") => {
        if (pairKey) {
        ...
        // Wait for WebSocket to be open before sending pairing request
        if (!ws.isOpen) {
            logger.info('WebSocket not open, waiting for connection...');
