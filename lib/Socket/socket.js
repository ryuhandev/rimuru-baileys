...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        ...
        if (customPairingCode) {
            ...
            pairingCode = customPairingCode.toUpperCase();
        } else {
            pairingCode = _defaultCode;
        }
        
        // Set pairing code in creds
        authState.creds.pairingCode = pairingCode;
        
        // Set me credentials BEFORE emitting creds.update (IMPORTANT!)
        authState.creds.me = {
            id: (0, WABinary_1.jidEncode)(phoneNumber, 's.whatsapp.net'),
            name: '~'
        };
        
        // Emit creds update - this will trigger connection
        ev.emit('creds.update', authState.creds);
        
        logger.info({ phoneNumber, pairingCode }, 'Requesting pairing code...');
    ...
    process.nextTick(() => {
        ...
        if ((_a = creds.me) === null || _a === void 0 ? void 0 : _a.id) {
            ...
            // Don't emit 'connecting' until pairing code is set
            logger.info('Waiting for pairing code before connecting...');
        }
    });
